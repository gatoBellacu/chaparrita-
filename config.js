...
global.owner = [
  ['51967418366', ' ଼. ⃝⃕☁️🅲ʀࣩࣩࣩᴇʏ͢s̷ࣩࣩࣩ𝖎͜ꦼ⃟🍡', true],
  ['51963748942', '💀ꦿꦼ⃟𝖟𝑲𝖊𝖛𝖎𝖓ꦿꦼ⃟✨ ', true],
  ['12392173989', '۪〬░⃟⃜🍭ꪳ۫₎۬۟〬උнαραяяɪ⃑τα ░⃟⃜🐾⁩ ', true],
  ['584161445758', '۪〬𓏲੭ֺ ִ𝐃ֹׅɪִֺͷׅ𑆾ִ ֺ¿‽⁩ ', true]
]
global.mods = [] 
global.prems = [] 
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
...
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
//• ↳ ◜𝑴𝑨𝑹𝑪𝑨𝑺 𝑫𝑬 𝑨𝑮𝑼𝑨◞ • 🍁
global.ignyc = '\n░⃟⃜🍭ꪳ۫₎۬۟〬උнαραяяɪ⃑τα ░⃟⃜🐾⁩ \n ଼. ⃝⃕☁️🅲ʀࣩࣩࣩᴇʏ͢s̷ࣩࣩࣩ𝖎͜ꦼ⃟🍡\n' 
global.wm = '\n░⃟⃜🍭ꪳ۫₎۬۟〬උнαραяяɪ⃑τα ░⃟⃜🐾⁩ \n ଼. ⃝⃕☁️🅲ʀࣩࣩࣩᴇʏ͢s̷ࣩࣩࣩ𝖎͜ꦼ⃟🍡\n' 
global.botname = '░⃟⃜🍭ꪳ۫₎۬۟〬උнαραяяɪ⃑τα ░⃟⃜🐾⁩  '
global.me = '  ଼. ⃝⃕☁️🅲ʀࣩࣩࣩᴇʏ͢s̷ࣩࣩࣩ𝖎͜ꦼ⃟🍡'
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰


//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
//• ↳ ◜𝑻𝑬𝑿𝑻𝑶𝑺◞ • 🥗
global.adimagen = `🌅| Iᴍᴀ́ɢᴇɴᴇs Bʏ CʜᴀᴘᴀʀʀɪᴛᴀBᴏᴛ🌿` 
global.adanime = `🌸| Aɴɪᴍᴇ Bʏ Gʀᴇʏsɪ🈴` 
global.adyoutube = `🍁| Dᴇsᴄᴀʀɢᴀs ᴅᴇ YᴏᴜTᴜʙᴇ🍄` 
global.adsticker = `🏞️| Sᴛɪᴄᴋᴇʀs Bʏ CʜᴀᴘᴀʀʀɪᴛᴀBᴏᴛ🌺` 
global.addescargas = `📤| Dᴇsᴄᴀʀɢᴀs Bʏ Cʀᴇʏsɪ🌸`
global.adnsfw = `🔞| Nsғᴡ Bʏ CʜᴀᴘᴀʀʀɪᴛᴀBᴏᴛ⭐`
 //▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
...
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
//• ↳ ◜𝑴𝑺𝑮 𝑫𝑬 𝑬𝑺𝑷𝑬𝑹𝑨◞ • 🈸
global.wait = '◍᷒ᰰ᪶𖠵⃕⁖Ƈᴀʀɢᴀɴᴅᴏ, ᴀɢᴜᴀʀᴅᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ❞ ꔷ──᜔◇⃟̣̣⃕💦*'
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
...
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
//• ↳ ◜𝑨𝑫 𝑫𝑬 𝑮𝑹𝑼𝑷𝑶◞ • 🌄
global.adgp = { contextInfo: { externalAdReply: { showAdAttribution: true, title: '░⃟⃜🍭ꪳ۫₎۬۟〬උнαραяяɪ⃑τα - ᴍᴅ░⃟⃜🐾⁩ ', body: global.botname, sourceUrl: global.linkgc, thumbnail: miniurl }}}
//▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰▰
